<?php
/**
 * modales_cursos.php - Modales para la gestión de cursos
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" class="form-control" id="crear_nombre" name="nombre" required
                                   placeholder="ej: 1° año A, 2° año B">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="crear_orientacion" name="orientacion" 
                                   value="Técnico en Electromecánica">
                        </div>
                        <div class="col-md-6 mb-3">
        ...
        <div class="modal-content">
            <form method="POST" action="cursos.php">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="editar_orientacion" class="form-label">Orientación</label>
                            <input type="text" class="form-control" id="editar_orientacion" name="orientacion">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="editar_ciclo_lectivo_id" class="form-label">Ciclo Lectivo *</label>
                            <select class="form-select" id="editar_ciclo_lectivo_id" name="ciclo_lectivo_id" required>
                                <?php foreach ($ciclosDisponibles as $ciclo): ?>
            ...
            <form method="POST" action="cursos.php">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Recursado:</strong> Permite que un estudiante de un curso superior recurse una materia de un año anterior.
                        Por ejemplo, un estudiante de 6° año puede recursar Matemática de 5° año.
                    </div>
                    
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="recursado_estudiante_id" class="form-label">Estudiante *</label>
                            <select class="form-select" id="recursado_estudiante_id" name="estudiante_id" required>
                                <option value="">-- Seleccione un estudiante --</option>
                                <?php foreach ($estudiantes as $estudiante): ?>
                                <option value="<?= $estudiante['id'] ?>">
                                    <?= htmlspecialchars($estudiante['apellido']) ?>, <?= htmlspecialchars($estudiante['nombre']) ?> (<?= $estudiante['dni'] ?>)
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="recursado_curso_origen" class="form-label">Curso de la Materia *</label>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <select class="form-select" id="recursado_materia_curso_id" name="materia_curso_id" required>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control" id="recursado_observaciones" name="observaciones" rows="3" 
                                      placeholder="Motivo del recursado, observaciones adicionales..."></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    <button type="submit" class="btn btn-warning">Asignar para Recursado</button>
                </div>
            </form>
        </div>
    </div>
